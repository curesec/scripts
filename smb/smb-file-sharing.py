    ...
    try:
        ...
        if conn:
            if args.listshares:
                ...
                smb_retrieve_file_from_offset(conn, args.retrievefilefromoffset[0], args.retrievefilefromoffset[1],
                                              args.retrievefilefromoffset[2], int(args.retrievefilefromoffset[3]),
                                              int(args.retrievefilefromoffset[4]), timeout)
            elif args.storefile:
...
def main():
    ...
    group.add_argument("-retrievefile", action="store", dest="retrievefile", nargs=3,
                       metavar=("share", "remotepath", "localpath"))
    group.add_argument("-retrievefilefromoffset", action="store", dest="retrievefilefromoffset", nargs=5,
                       metavar=("share", "remotepath", "localpath", "offset", "maxlength"))
    group.add_argument("-storefile", action="store", dest="storefile", nargs=3,
                       metavar=("share", "localpath", "remotepath"))
    ...
    group.add_argument("-deletedirectory", action="store", dest="deletedirectory", nargs=2,
                       metavar=("share", "remotepath"))
