...
def main():
    ...
    parser.add_argument("-P", action="store", dest="priv_protocol", required=False,
                        help="optional; DES (default), 3DES, AES128, AES192, AES256")
    ...
    parser.add_argument("-oid", action="store", dest="oid", default="1.3.6.1.2.1", required=False,
                        help="default 1.3.6.1.2.1. Specify the subtree to enumerate, 1.3 for all")
    parser.add_argument("-n", action="store_true", dest="n", default=False, required=False,
                        help="print OIDs numerically")
    parser.add_argument("-maxrows", action="store", dest="maxrows", type=int, default=0, required=False,
                        help="default 0. Limit the results")
