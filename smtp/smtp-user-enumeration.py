...
def main(argv):
    ...
    parser.add_argument('-userfile', action="store", dest="userfile", required=True,
                        help="file containing usernames separated by newlines")
    parser.add_argument("-timeout", action="store", dest="timeout", default="5", required=False,
    ...
    smtpuserenumerator = SMTPUserEnumerator(args.rhost, args.rport, args.command, args.userfile, args.timeout,
                                            args.verbose)
